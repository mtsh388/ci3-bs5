	...
	var $dialog = $(
		...
		'<div class="modal-content">' +
			...
			'<div class="modal-body">' +
				'<div class="progress progress-striped progress-xs  active" style="margin-bottom:0;"><div class="progress-bar" style="width: 100%"></div></div>' +
			'</div>' +
		'</div></div></div>');
	...
	return {
		...
		show: function (message, options) {
			...
			if (typeof message === 'undefined') {
				message = 'Please Wait, Request in progress...';
			}
			var settings = $.extend({
				dialogSize: 'xs',
				progressType: 'info',
